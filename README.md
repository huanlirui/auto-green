...
[![Build Status](https://github.com/huanlirui/auto-green/workflows/ci/badge.svg?branch=master)](https://github.com/huanlirui/auto-green/actions)
...
- 修改 [ci.yml 文件的第 19、20 行](https://github.com/huanlirui/auto-green/blob/master/.github/workflows/ci.yml#L19) 为自己的 GitHub 账号和昵称
- (可选) 你可以通过修改 [ci.yml 文件的第 8 行](https://github.com/huanlirui/auto-green/blob/master/.github/workflows/ci.yml#L8)来调整频率
